...
import org.comstudy21.ex06.MyJFrame;
...
public class TestJTable extends MyJFrame {
	...
	private void displaySerch(String Name) {
		tbModel.setDataVector(null, columnNames);
		Vector<Vector> saramList = dao.SelectOne(Name);
	...
	protected void actionEvent() {
		...
		modifyBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String CHname = txtFld2.getText();
				txtFld2.setText("");
				String CHemail = txtFld3.getText();
				txtFld3.setText("");
				String CHphone = txtFld4.getText();
				txtFld4.setText("");
				
				dao.modify(CHname,CHemail,CHphone);
				displaySerch(CHname);
